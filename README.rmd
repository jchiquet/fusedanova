...
Slot 'as.hclust.fusednova' method of a fusedanova object convert dastly to an "hclust" object, so you can rely on the available methods for this kind of object:

```{r dendrogram}
par(mfrow=c(2,2))
plot(as.dendrogram(as.hclust(fa.default)), type="triangle", main="default weights")
plot(as.dendrogram(as.hclust(fa.laplace)), type="triangle", main="Laplace weights")
plot(as.dendrogram(as.hclust(fa.gaussian)), type="triangle", main="Gaussian weights")
plot(as.dendrogram(as.hclust(fa.adaptive)), type="triangle", main="adaptive weights")

cutree(as.hclust(fa.adaptive), c(2, 6))
```
...
plot(as.phylo(as.hclust(fa)), type="fan", tip.color=as.numeric(aves$family))
plot(as.phylo(as.hclust(fa)), type="fan", tip.color=as.numeric(aves$order))
```
